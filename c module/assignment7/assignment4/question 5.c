...
#include<stdio.h>
void performoperations(int*);
void main()
{
	printf("This is the mainu driven for your operations\n");
	printf("To check number is even or odd enter  : 1 \n");
	printf("To check number is prime or not enter  : 2\n");
	printf("To check number is pallindrome or not enter  : 3\n");
	printf("To check number is positive, negative or zero enter : 4\n");
	printf("To reverse a number enter  : 5\n");
	printf("To find sum of digits enter  : 6\n");
